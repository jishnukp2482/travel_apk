              ...
              Obx(
                () => Row(
                  children: [
                    ...
                    Text(cntrl.likecount2.toString()),
                  ],
                ),
              ),
              const SizedBox(
              ...
              Obx(
                () => Row(
                  children: [
                    IconButton(
                        onPressed: () {
                          if (!cntrl.likedecrement2.value) {
                            cntrl.james2unlike();
                          }
                        },
                        icon: Icon(Icons.thumb_down, color: cntrl.btncolor)),
                    Text(
                      cntrl.unlikecount2.toString(),
                    ),
                  ],
                ),
              ),
